...
const dict: Record<Lang, Dict> = {
  ca: {
    ...
    auto: "Mode auto",
    tipAuto:
      "Mode auto: el motor juga sol (Negres i Blanques). Torna a prémer per aturar-lo.",
    nigiri: "Nigiri (triar color)",
    nigiriHelp:
      "Toca el teu bol: 1 pedra = senar, 2 = parell. Després, Revelar.",
    you: "Tu",
    machine: "Màquina",
    reveal: "Revelar",
    nigiriWon: "Has encertat! Jugues amb Negres.",
    nigiriLost: "No has encertat. Jugues amb Blanques.",
    nigiriPlay: "Començar",
    eyeWarn:
      "Estàs a punt de jugar dins d'un ull teu. Sol ser una mala jugada: pots afeblir o perdre el grup. Segur?",
    yes: "Sí",
    no: "No",
    board: "Tauler",
    opponent: "Oponent",
    ...
    countingTitle: "Recompte",
    countingInstruction: "Marca les pedres mortes tocant-les",
    finishCounting: "Finalitzar recompte",
    resumeCounting: "Reprendre recompte",
    pass: "Passar",
    hint: "Pista",
    ...
    blackCaptures: "Negres capturades",
    whiteCaptures: "Blanques capturades",
    ...
    reasonSuicide:
      "Això seria suïcidi: la teva pedra quedaria sense llibertats.",
  ...
  es: {
    ...
    auto: "Modo auto",
    tipAuto:
      "Modo auto: el motor juega solo (Negras y Blancas). Pulsa de nuevo para pararlo.",
    nigiri: "Nigiri (elegir color)",
    nigiriHelp: "Toca tu cuenco: 1 piedra = impar, 2 = par. Luego, Revelar.",
    you: "Tú",
    machine: "Máquina",
    reveal: "Revelar",
    nigiriWon: "¡Has acertado! Juegas con Negras.",
    nigiriLost: "No has acertado. Juegas con Blancas.",
    nigiriPlay: "Empezar",
    eyeWarn:
      "Estás a punto de jugar dentro de un ojo tuyo. Suele ser mala jugada: puedes debilitar o perder el grupo. ¿Seguro?",
    yes: "Sí",
    no: "No",
    board: "Tablero",
    opponent: "Oponente",
    ...
    countingTitle: "Recuento",
    countingInstruction: "Marca las piedras muertas tocándolas",
    finishCounting: "Finalizar recuento",
    resumeCounting: "Reanudar recuento",
    pass: "Pasar",
    hint: "Pista",
    ...
    hintNote:
      "Dos pases seguidos terminan la partida y se cuenta el territorio.",
    ...
    blackCaptures: "Negras capturadas",
    whiteCaptures: "Blancas capturadas",
  ...
  en: {
    ...
    auto: "Auto mode",
    tipAuto:
      "Auto mode: the engine plays itself (Black and White). Tap again to stop.",
    nigiri: "Nigiri (choose colour)",
    nigiriHelp: "Tap your bowl: 1 stone = odd, 2 = even. Then Reveal.",
    you: "You",
    machine: "Machine",
    reveal: "Reveal",
    nigiriWon: "Correct! You play Black.",
    nigiriLost: "Not this time. You play White.",
    nigiriPlay: "Start",
    eyeWarn:
      "You're about to play inside your own eye. This is usually a bad move: you may weaken or lose the group. Are you sure?",
    yes: "Yes",
    no: "No",
    board: "Board",
    opponent: "Opponent",
    ...
    countingTitle: "Scoring",
    countingInstruction: "Tap the dead stones to mark them",
    finishCounting: "Finish scoring",
    resumeCounting: "Resume scoring",
    pass: "Pass",
    hint: "Hint",
